...
class TestServeAPI:
    ...
    def test_serve_status_endpoint(self):
        ...
        from app.api.serve import router, ServeStatus

        # Verify the response model
        assert ServeStatus.model_fields["loaded"].annotation == bool
        assert ServeStatus.model_fields["device"].annotation == str
    ...
    def test_image_prediction_response_model(self):
        from app.api.serve import ImagePredictionResponse, DetectionOut
