...
3. **Docker Desktop** — install from [https://www.docker.com/products/docker-desktop](https://www.docker.com/products/docker-desktop). Enable "Use the WSL 2 based engine" in Settings → General.
4. **Git for Windows** — install from [https://git-scm.com](https://git-scm.com).
